...
copy::sptr copy::make(size_t itemsize, bool passthrough)
{
    return gnuradio::make_block_sptr<copy_impl>(itemsize, passthrough);
}

/*
 * The private constructor
 */
copy_impl::copy_impl(size_t itemsize, bool passthrough)
    : gr::sync_block("copy",
                    ...
                    gr_vector_void_star& output_items)
{
    ...
    // 2. Copy data if not passthrough mode
    if (!d_passthrough) {
