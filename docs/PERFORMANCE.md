...
- **FFTW (CPU)** peaks at 0.46 Gsps (ARM Cortex-X925) and 1.02 Gsps (AMD EPYC 9335). cuFFT provides a **20-60x speedup** over single-threaded FFTW depending on FFT size and GPU.
