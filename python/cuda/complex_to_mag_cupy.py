...
class complex_to_mag_cupy(cuda.sync_block):
    """Computes the magnitude of complex samples on the GPU using CuPy."""
    ...
    def __init__(self, vlen: int = 1):
        ...
        cuda.sync_block.__init__(self, "complex_to_mag_cupy", [in_dtype], [out_dtype])
